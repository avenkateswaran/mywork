...
public class Organisation_PAYE {
	...
	private static final String TEST_DATA_FILE_NAME = "Organisation PAYE.csv";
	...
	// private String NINO;
	private String RefEmpP1;
	private String RefEmpP2;
	// private String RefNub;
	// private String RefCode;
	private String RefAcc;

	public Organisation_PAYE(Map<String, String> testDataRow) {
		...
		this.RefEmpP1 = testDataRow.get("Employee ref part 1");
		this.RefEmpP2 = testDataRow.get("Employee ref part 2");
		// this.RefNub = testDataRow.get("Reference Number");
		// this.RefCode = testDataRow.get("Reference Code");
		this.RefAcc = testDataRow.get("Accounts Office Reference");
	}
	...
	public static void openBrowser() throws Exception {
		...
		evidenceCollector = new resources.EvidenceCollector(Organisation_PAYE.class.getName());
	...
	@Test
	public void OrganisationPAYE() throws Exception {
		...
		try {
			...
			/* Start log */
			page.writeLog("=============== Start TEST CASE : Organisation PAYE  =========================== "
			...
			driver.findElement(gatewayRegistrationPage.AddTaxPAYE).click();
			driver.findElement(gatewayRegistrationPage.BA_Continue).click();
			driver.findElement(gatewayRegistrationPage.EmployerPAYE).click();
			driver.findElement(gatewayRegistrationPage.BA_Continue).click();
			Thread.sleep(7000);
			driver.findElement(By.id("FieldregistrationOptions2")).click();
			page.clickNext();
			driver.findElement(By.linkText("PAYE for Employers")).click();
			Thread.sleep(500);

			/* Enrol for Organisation PAYE */
			gatewayRegistrationPage.constructionIndustry(gatewayRegistrationPage, RefEmpP1, RefEmpP2, RefAcc);
			Thread.sleep(5000);
		...
		/* End log */
		page.writeLog("=============== End TEST CASE : Organisation PAYE  =========================== "
				+ currentlyRunningTest.getMethodName());
	...
	public static void closeBrowser() throws Exception {
		...
		if (page.successCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, true, 9, 4, page.successCount);
		}
		if (page.failCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, false, 9, 4, page.failCount);
		}
