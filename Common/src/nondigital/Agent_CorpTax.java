...
public class Agent_CorpTax {
	...
	private static final String TEST_DATA_FILE_NAME = "Agent CorpTax.csv";
	...
	private String CTref;

	public Agent_CorpTax(Map<String, String> testDataRow) {
		...
		this.CTref = testDataRow.get("CT Tax Ref Num");
	...
	public static void openBrowser() throws Exception{
		...
		evidenceCollector = new resources.EvidenceCollector(Agent_CorpTax.class.getName());
	...
	@Test
	public void AgentCorporationTax() throws Exception {
		...
		/* Start log */	
		page.writeLog("=============== Start TEST CASE : Agent Corporation Tax  =========================== " + currentlyRunningTest.getMethodName());
		...
		driver.findElement(gatewayDetailsPage.CorpTaxForAgents).click();
		...
		/* Redirect to Agent Corporation Tax page */
		driver.get("https://ibt.hmrc.gov.uk/service/corporation-tax?action=enrol&step=enterdetails");
		gatewayRegistrationPage.enrolforAgentCorpTax(gatewayRegistrationPage, CTref, postcode);
		Thread.sleep(5000);
		...
		/* End log */
		page
		.writeLog("=============== End TEST CASE : Agent Corporation Tax  =========================== " + currentlyRunningTest.getMethodName());
	...
	public static void closeBrowser() throws Exception {
		...
		if (page.successCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, true, 2, 4, page.successCount);
		}
		if (page.failCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, false, 2, 4, page.failCount);
		}
