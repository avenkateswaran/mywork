...
public class Organisation_SA_PART {
	...
	private static final String TEST_DATA_FILE_NAME = "Organisation SA Partnership.csv";
	...
	public Organisation_SA_PART(Map<String, String> testDataRow) {
	...
	public static void openBrowser() throws Exception {
		...
		evidenceCollector = new resources.EvidenceCollector(Organisation_SA_PART.class.getName());
	}
	...
	@Test
	public void OrganisationSAPartnership() throws Exception {
		...
		try {
			...
			/* Start log */
			page.writeLog("=============== Start TEST CASE : Organisation SA Partnership  =========================== "
			...
			driver.findElement(gatewayRegistrationPage.SAPartnership).click();
			driver.findElement(gatewayRegistrationPage.BA_Continue).click();
			driver.findElement(gatewayRegistrationPage.DoSomethingElse).click();
			driver.findElement(gatewayRegistrationPage.BA_Continue).click();
			Thread.sleep(500);
			driver.findElement(gatewayRegistrationPage.ExistingPartner).click();
			driver.findElement(gatewayRegistrationPage.BA_Continue).click();
			Thread.sleep(7000);

			/* Enrol details for SA Partnership */
		...
		page.writeLog("=============== End TEST CASE : Organisation SA Partnership  =========================== "
				+ currentlyRunningTest.getMethodName());
	...
	public static void closeBrowser() throws Exception {
		...
		if (page.successCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, true, 10, 4, page.successCount);
		}
		if (page.failCount != 0){
			evidenceCollector.reporter.createReport(evidenceCollector.testCaseStartTime,evidenceCollector.testCaseEndTime, false, 10, 4, page.failCount);
		}
