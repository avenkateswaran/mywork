...
public class Test1 {
	...
	private static final String TEST_DATA_FILE_NAME = "tsr_pro160628sh_17_SA_test1.csv";
...
//	public final ErrorCollector collector = new ErrorCollector();
	...
	public static void openBrowser() throws Exception {
		...
		oracleChecks = new OracleChecks("4835832051"); //set this to testDataRow.get("UTR");
...
//		evidenceCollector.newTestCase();
	...
	public void Test() throws Exception {
		...
		try {
			...
			//tailorYourReturnPage.setSelfEmployedBusiness(testDataRow.get("How many self-employed businesses did you have?"), testDataRow.get("Business 1 name"));
		...
		//	checkYourReturnPage = fillInYourReturnAnyOtherInfoPage2.clickNextGoToCheckYourReturnPage();
			viewYourCalculationSummaryPage = checkYourReturnPage.clickNext();
			viewYourCalculationSummaryPage.clickNextGoToSaveYourReturnPage();
