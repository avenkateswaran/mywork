...
public class AboutTheBusinessConfirmationSAPage extends BasePage{
	...
	public static By FielddoNotEnrolSAOnline = By.id("FielddoNotEnrolSAOnline");

	public AboutTheBusinessConfirmationSAPage(WebDriver driver) {
		super(driver);
